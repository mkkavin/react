      ...
      <main class="main">
        <section className="home bd_grid" id="home">
          <div className="home_data" data-aos="fade-down">
            <h1 className="home_title" style={{ color: "black" }}>
              Hi, <br />I'm <span className="home_title-color">Kavin M</span>
          ...
          <div className="home_social">
            <a href="https://www.facebook.com/profile.php?id=100094950453969&mibextid=ZbWKwL" className="home_social-icon" data-aos="fade-down">
              <i className="bx bxl-facebook-circle"></i>
            </a>
            <a href="https://instagram.com/mk_kavin_?igshid=MzNlNGNkZWQ4Mg==" className="home_social-icon" data-aos="fade-down" data-aos-delay="250">
              <i className="bx bxl-instagram"></i>
            </a>
            <a href="https://www.linkedin.com/in/kavin-muthu-62952622a" className="home_social-icon" data-aos="fade-down" data-aos-delay="300">
              <i className="bx bxl-linkedin"></i>
            </a>
            <a href="https://github.com/mkkavin" className="home_social-icon" data-aos="fade-down" data-aos-delay="350">
              <i className="bx bxl-github"></i>
            </a>
          </div>
          <div className="home_img" data-aos="fade-down" data-aos-delay="500">
            <img src='./assets/img/hero-bg.jpeg' alt="working remotely" />
          </div>
        </section>
        ...
        <section class="about section" id="about">
          ...
          <div class="about_container bd_grid">
            <div class="about_img" data-aos="fade-down" data-aos-delay="50">
              <img src="./assets/img/img-2.jpeg" alt="img" style={{ "margin-left": "50px" }} width="300px" height="500px"></img>
              <title>profile</title>
            ...
            <div>
              ...
              <p class="about_text" data-aos="fade-down" data-aos-delay="450">
                Greetings! I'm Kavin, a passionate and dedicated front-end developer with a keen eye for design and
                a strong technical skill set. I find joy in transforming creative ideas into stunning and interactive web experiences.
                Let me share a bit about myself and my journey as a front-end developer.
              </p>
            </div>
          </div>
        </section>
        ...
        <section class="skills section" id="skills">
          ...
          <div class="skills_container bd_grid">
            <div>
              ...
              <div class="skills_data" data-aos="fade-right" data-aos-delay="250">
                <div class="skills_name">
                  ...
                  <span class="skill_name">Bootstrap</span>
                </div>
            ...
            <div data-aos="fade-left" data-aos-delay="350">
              <img src="./assets/img/skill.avif" alt="img"></img>
              <circle
                cx="75.36532"
                cy="147.52379"
                r="75.36532"
        ...
        <section class="skills section" id="skills">
          <h2 class="section-title" data-aos="fade-down">Tools</h2>
          ...
          <div class="skills_container bd_grid">
            <div>
              ...
              <div class="skills_data" data-aos="fade-right">
                <div class="skills_name">
                  <i class="bx bxl-visual-studio skill_icon"></i>
                  <span class="skill_name">Visual Studio</span>
                </div>

                <div><span class="skill_percentage">80%</span></div>

                <div class="skill_bar skill_vs"></div>
              </div>

              <div class="skills_data" data-aos="fade-right" data-aos-delay="250">
                <div class="skills_name">
                  <i class="bx bxl-github skill_icon"></i>
                  <span class="skill_name">GitHub</span>
                </div>

                <div><span class="skill_percentage">90%</span></div>

                <div class="skill_bar skill_gh"></div>
              </div>

              <div class="skills_data" data-aos="fade-right" data-aos-delay="250">
                <div class="skills_name">
                  <i class="bx bxl-figma skill_icon"></i>
                  <span class="skill_name">Figma</span>
                </div>

                <div><span class="skill_percentage">75%</span></div>

                <div class="skill_bar skill_fi"></div>
              </div>
            </div>
        ...
        <section class="work section" id="work">
          ...
          >
            <div class="work_img">
              <a href="https://zomato-website-clone.netlify.app/" ><img src="./assets/img/Zomato.jpg" alt="" /></a>
            </div>

            <div class="work_img">
              <a href="https://kavin-js.netlify.app/calculator/"><img src="./assets/img/cal.png" alt="" /></a>
            </div>

            <div class="work_img">
              <a href="https://kavin-js.netlify.app/clock/"><img src="./assets/img/clk.png" alt="" /></a>
            </div>

            <div class="work_img">
              <a href="https://kavin-js.netlify.app/stopwatch/"><img src="./assets/img/stw.png" alt="" /></a>
            </div>

            <div class="work_img">
              <a href="https://kavin-js.netlify.app/rock-paper-scissors/"><img src="./assets/img/rps.png" alt="" /></a>
            </div>

            <div class="work_img">
              <a href="https://kavin-js.netlify.app/whack-a-mole/"><img src="./assets/img/wam.png" alt="" /></a>
            </div>
          </div>
        </section>
        ...
        <footer class="footer">
          <p class="footer_title" data-aos="fade-down">Kavin M</p>

          <div class="footer_socials">
            <a
              href="https://www.facebook.com/profile.php?id=100094950453969&mibextid=ZbWKwL"
              class="footer_icon"
              data-aos="fade-down"
              data-aos-delay="250"
            ...
            ></a>
            <a
              href="https://instagram.com/mk_kavin_?igshid=MzNlNGNkZWQ4Mg=="
              class="footer_icon"
              data-aos="fade-down"
              data-aos-delay="350"
            ...
            ></a>
            <a
              href="https://www.linkedin.com/in/kavin-muthu-62952622a"
              class="footer_icon"
              data-aos="fade-down"
              data-aos-delay="450"
